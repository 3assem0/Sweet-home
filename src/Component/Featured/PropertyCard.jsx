...
const PropertyCard = ({ image, statusLabel, statusColor, title, price, agent, location, agentImage }) => {
  ...
  return (
    <div className="min-w-[250px] m-4 max-sm:m-0 max-sm:min-w-[200px] max-sm:ml-2 bg-white rounded-lg">
      <div className="relative">
        <img src={image} alt={title} className="rounded-lg w-[240px] max-sm:w-[200px] h-[282px] " />
